			...
			<div class="container">
				<div class="row">
					<div class="page_header text-center">
						<h2>Shop</h2>
						<p>Get the best fabric for your special ocassion</p>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-7 product-single">
							...
							<div class="p-price">CAD <?php echo $prodr['price']; ?>.00</div>
							 ...
							 ?>	
								<div class="sm-item isotope-item">
									<div class="product">
										...
										<div class="product-price">CAD <?php echo $relr['price']; ?>.00<span></span></div>
									</div>
								</div>
							<?php } ?>	
							</div>
